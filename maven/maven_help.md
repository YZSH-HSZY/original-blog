...
maven 是一个构建工具，你可以使用 maven 进行 java 项目的依赖管理，帮助我们快速开发项目，而不必耗费大量时间去解决依赖配置问题。
...
- 使用 maven 的显示依赖命令解决==依赖包版本冲突==问题

- 非 compile 范围的==依赖包是不能传递的==。
